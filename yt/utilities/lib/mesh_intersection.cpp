...
#define __PYX_HAVE__yt__utilities__lib__mesh_intersection
#define __PYX_HAVE_API__yt__utilities__lib__mesh_intersection
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
static void (*__pyx_f_2yt_9utilities_3lib_13mesh_samplers_sample_hex20)(void *, struct RTCRay &); /*proto*/
...
#define __Pyx_MODULE_NAME "yt.utilities.lib.mesh_intersection"
int __pyx_module_is_main_yt__utilities__lib__mesh_intersection = 0;

/* Implementation of 'yt.utilities.lib.mesh_intersection' */
...
/* "yt/utilities/lib/mesh_intersection.pyx":37
...
static void __pyx_f_2yt_9utilities_3lib_17mesh_intersection_patchBoundsFunc(__pyx_t_2yt_9utilities_3lib_17mesh_construction_Patch *__pyx_v_patches, size_t __pyx_v_item, struct RTCBounds *__pyx_v_bounds_o) {
  ...
  /* "yt/utilities/lib/mesh_intersection.pyx":41
 *                           rtcg.RTCBounds* bounds_o) nogil:
 * 
 ...
 */
  __pyx_v_patch = (__pyx_v_patches[__pyx_v_item]);

  /* "yt/utilities/lib/mesh_intersection.pyx":43
 *     cdef Patch patch = patches[item]
 * 
 *     cdef float lo_x = 1.0e300             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_lo_x = 1.0e300;

  /* "yt/utilities/lib/mesh_intersection.pyx":44
 * 
 *     cdef float lo_x = 1.0e300
 *     cdef float lo_y = 1.0e300             # <<<<<<<<<<<<<<
 *     cdef float lo_z = 1.0e300
 * 
 */
  __pyx_v_lo_y = 1.0e300;

  /* "yt/utilities/lib/mesh_intersection.pyx":45
 *     cdef float lo_x = 1.0e300
 *     cdef float lo_y = 1.0e300
 *     cdef float lo_z = 1.0e300             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_lo_z = 1.0e300;

  /* "yt/utilities/lib/mesh_intersection.pyx":47
 *     cdef float lo_z = 1.0e300
 * 
 *     cdef float hi_x = -1.0e300             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_hi_x = -1.0e300;

  /* "yt/utilities/lib/mesh_intersection.pyx":48
 * 
 *     cdef float hi_x = -1.0e300
 *     cdef float hi_y = -1.0e300             # <<<<<<<<<<<<<<
 *     cdef float hi_z = -1.0e300
 * 
 */
  __pyx_v_hi_y = -1.0e300;

  /* "yt/utilities/lib/mesh_intersection.pyx":49
 *     cdef float hi_x = -1.0e300
 *     cdef float hi_y = -1.0e300
 *     cdef float hi_z = -1.0e300             # <<<<<<<<<<<<<<
 * 
 *     cdef int i
 */
  __pyx_v_hi_z = -1.0e300;

  /* "yt/utilities/lib/mesh_intersection.pyx":52
 * 
 *     cdef int i
 *     for i in range(8):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 8; __pyx_t_1+=1) {
    ...
    /* "yt/utilities/lib/mesh_intersection.pyx":53
 *     cdef int i
 *     for i in range(8):
 *         lo_x = fmin(lo_x, patch.v[i][0])             # <<<<<<<<<<<<<<
 *         lo_y = fmin(lo_y, patch.v[i][1])
 ...
 */
    __pyx_v_lo_x = fmin(__pyx_v_lo_x, ((__pyx_v_patch.v[__pyx_v_i])[0]));

    /* "yt/utilities/lib/mesh_intersection.pyx":54
 *     for i in range(8):
 *         lo_x = fmin(lo_x, patch.v[i][0])
 *         lo_y = fmin(lo_y, patch.v[i][1])             # <<<<<<<<<<<<<<
 *         lo_z = fmin(lo_z, patch.v[i][2])
 ...
 */
    __pyx_v_lo_y = fmin(__pyx_v_lo_y, ((__pyx_v_patch.v[__pyx_v_i])[1]));

    /* "yt/utilities/lib/mesh_intersection.pyx":55
 *         lo_x = fmin(lo_x, patch.v[i][0])
 *         lo_y = fmin(lo_y, patch.v[i][1])
 *         lo_z = fmin(lo_z, patch.v[i][2])             # <<<<<<<<<<<<<<
 *         hi_x = fmax(hi_x, patch.v[i][0])
 ...
 */
    __pyx_v_lo_z = fmin(__pyx_v_lo_z, ((__pyx_v_patch.v[__pyx_v_i])[2]));

    /* "yt/utilities/lib/mesh_intersection.pyx":56
 *         lo_y = fmin(lo_y, patch.v[i][1])
 *         lo_z = fmin(lo_z, patch.v[i][2])
 *         hi_x = fmax(hi_x, patch.v[i][0])             # <<<<<<<<<<<<<<
 *         hi_y = fmax(hi_y, patch.v[i][1])
 ...
 */
    __pyx_v_hi_x = fmax(__pyx_v_hi_x, ((__pyx_v_patch.v[__pyx_v_i])[0]));

    /* "yt/utilities/lib/mesh_intersection.pyx":57
 *         lo_z = fmin(lo_z, patch.v[i][2])
 *         hi_x = fmax(hi_x, patch.v[i][0])
 *         hi_y = fmax(hi_y, patch.v[i][1])             # <<<<<<<<<<<<<<
 *         hi_z = fmax(hi_z, patch.v[i][2])
 * 
 */
    __pyx_v_hi_y = fmax(__pyx_v_hi_y, ((__pyx_v_patch.v[__pyx_v_i])[1]));

    /* "yt/utilities/lib/mesh_intersection.pyx":58
 *         hi_x = fmax(hi_x, patch.v[i][0])
 *         hi_y = fmax(hi_y, patch.v[i][1])
 *         hi_z = fmax(hi_z, patch.v[i][2])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_hi_z = fmax(__pyx_v_hi_z, ((__pyx_v_patch.v[__pyx_v_i])[2]));
  }

  /* "yt/utilities/lib/mesh_intersection.pyx":60
 *         hi_z = fmax(hi_z, patch.v[i][2])
 * 
 *     bounds_o.lower_x = lo_x             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_bounds_o->lower_x = __pyx_v_lo_x;

  /* "yt/utilities/lib/mesh_intersection.pyx":61
 * 
 *     bounds_o.lower_x = lo_x
 *     bounds_o.lower_y = lo_y             # <<<<<<<<<<<<<<
 *     bounds_o.lower_z = lo_z
 ...
 */
  __pyx_v_bounds_o->lower_y = __pyx_v_lo_y;

  /* "yt/utilities/lib/mesh_intersection.pyx":62
 *     bounds_o.lower_x = lo_x
 *     bounds_o.lower_y = lo_y
 *     bounds_o.lower_z = lo_z             # <<<<<<<<<<<<<<
 *     bounds_o.upper_x = hi_x
 ...
 */
  __pyx_v_bounds_o->lower_z = __pyx_v_lo_z;

  /* "yt/utilities/lib/mesh_intersection.pyx":63
 *     bounds_o.lower_y = lo_y
 *     bounds_o.lower_z = lo_z
 *     bounds_o.upper_x = hi_x             # <<<<<<<<<<<<<<
 *     bounds_o.upper_y = hi_y
 ...
 */
  __pyx_v_bounds_o->upper_x = __pyx_v_hi_x;

  /* "yt/utilities/lib/mesh_intersection.pyx":64
 *     bounds_o.lower_z = lo_z
 *     bounds_o.upper_x = hi_x
 *     bounds_o.upper_y = hi_y             # <<<<<<<<<<<<<<
 *     bounds_o.upper_z = hi_z
 * 
 */
  __pyx_v_bounds_o->upper_y = __pyx_v_hi_y;

  /* "yt/utilities/lib/mesh_intersection.pyx":65
 *     bounds_o.upper_x = hi_x
 *     bounds_o.upper_y = hi_y
 *     bounds_o.upper_z = hi_z             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_v_bounds_o->upper_z = __pyx_v_hi_z;
...
/* "yt/utilities/lib/mesh_intersection.pyx":71
 * @cython.wraparound(False)
 * @cython.cdivision(True)
...
static void __pyx_f_2yt_9utilities_3lib_17mesh_intersection_patchIntersectFunc(__pyx_t_2yt_9utilities_3lib_17mesh_construction_Patch *__pyx_v_patches, struct RTCRay &__pyx_v_ray, size_t __pyx_v_item) {
  __pyx_t_2yt_9utilities_3lib_17mesh_construction_Patch __pyx_v_patch;
  ...
  /* "yt/utilities/lib/mesh_intersection.pyx":75
 *                              size_t item) nogil:
 * 
 *     cdef Patch patch = patches[item]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "yt/utilities/lib/mesh_intersection.pyx":77
 *     cdef Patch patch = patches[item]
 * 
 *     cdef RayHitData hd = compute_patch_hit(patch.v, ray.org, ray.dir)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_hd = __pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_compute_patch_hit(__pyx_v_patch.v, __pyx_v_ray.org, __pyx_v_ray.dir);

  /* "yt/utilities/lib/mesh_intersection.pyx":80
 * 
 *     # only count this is it's the closest hit
 ...
 * 
 */
  __pyx_t_2 = ((__pyx_v_hd.t < __pyx_v_ray.tnear) != 0);
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_2 = ((__pyx_v_hd.t > (__pyx_v_ray.Ng[0])) != 0);
  __pyx_t_1 = __pyx_t_2;
  __pyx_L4_bool_binop_done:;
  if (__pyx_t_1) {

    /* "yt/utilities/lib/mesh_intersection.pyx":81
 *     # only count this is it's the closest hit
 *     if (hd.t < ray.tnear or hd.t > ray.Ng[0]):
 *         return             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "yt/utilities/lib/mesh_intersection.pyx":83
 *         return
 * 
 *     if (fabs(hd.u) <= 1.0 and fabs(hd.v) <= 1.0 and hd.converged):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "yt/utilities/lib/mesh_intersection.pyx":86
 * 
 *         # we have a hit, so update ray information
 *         ray.u = hd.u             # <<<<<<<<<<<<<<
 *         ray.v = hd.v
 ...
 */
    __pyx_t_3 = __pyx_v_hd.u;
    __pyx_v_ray.u = __pyx_t_3;

    /* "yt/utilities/lib/mesh_intersection.pyx":87
 *         # we have a hit, so update ray information
 *         ray.u = hd.u
 *         ray.v = hd.v             # <<<<<<<<<<<<<<
 *         ray.geomID = patch.geomID
 *         ray.primID = item
 */
    __pyx_t_3 = __pyx_v_hd.v;
    __pyx_v_ray.v = __pyx_t_3;

    /* "yt/utilities/lib/mesh_intersection.pyx":88
 *         ray.u = hd.u
 *         ray.v = hd.v
 *         ray.geomID = patch.geomID             # <<<<<<<<<<<<<<
 *         ray.primID = item
 *         ray.Ng[0] = hd.t
 */
    __pyx_t_4 = __pyx_v_patch.geomID;
    __pyx_v_ray.geomID = __pyx_t_4;

    /* "yt/utilities/lib/mesh_intersection.pyx":89
 *         ray.v = hd.v
 *         ray.geomID = patch.geomID
 *         ray.primID = item             # <<<<<<<<<<<<<<
 *         ray.Ng[0] = hd.t
 * 
 */
    __pyx_v_ray.primID = __pyx_v_item;

    /* "yt/utilities/lib/mesh_intersection.pyx":90
 *         ray.geomID = patch.geomID
 *         ray.primID = item
 *         ray.Ng[0] = hd.t             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    (__pyx_v_ray.Ng[0]) = __pyx_t_3;

    /* "yt/utilities/lib/mesh_intersection.pyx":93
 * 
 *         # sample the solution at the calculated point
 ...
 *     return
 */
    __pyx_f_2yt_9utilities_3lib_13mesh_samplers_sample_hex20(__pyx_v_patches, __pyx_v_ray);
 ...
 */
  ...
  /* "yt/utilities/lib/mesh_intersection.pyx":95
 *         sample_hex20(patches, ray)
 * 
 *     return             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "yt.utilities.lib.mesh_intersection.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "yt.utilities.lib.mesh_intersection.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "yt.utilities.lib.mesh_intersection.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "yt.utilities.lib.mesh_intersection._memoryviewslice", /*tp_name*/
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "mesh_intersection",
    __pyx_k_This_file_contains_functions_us, /* m_doc */
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initmesh_intersection(void); /*proto*/
PyMODINIT_FUNC initmesh_intersection(void)
#else
PyMODINIT_FUNC PyInit_mesh_intersection(void); /*proto*/
PyMODINIT_FUNC PyInit_mesh_intersection(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_mesh_intersection(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("mesh_intersection", __pyx_methods, __pyx_k_This_file_contains_functions_us, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_yt__utilities__lib__mesh_intersection) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "yt.utilities.lib.mesh_intersection")) {
      if (unlikely(PyDict_SetItemString(modules, "yt.utilities.lib.mesh_intersection", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("patchIntersectFunc", (void (*)(void))__pyx_f_2yt_9utilities_3lib_17mesh_intersection_patchIntersectFunc, "void (__pyx_t_2yt_9utilities_3lib_17mesh_construction_Patch *, struct RTCRay &, size_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("patchBoundsFunc", (void (*)(void))__pyx_f_2yt_9utilities_3lib_17mesh_intersection_patchBoundsFunc, "void (__pyx_t_2yt_9utilities_3lib_17mesh_construction_Patch *, size_t, struct RTCBounds *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  ...
  __pyx_vtabptr_2yt_9utilities_3lib_16element_mappings_ElementSampler = (struct __pyx_vtabstruct_2yt_9utilities_3lib_16element_mappings_ElementSampler*)__Pyx_GetVtable(__pyx_ptype_2yt_9utilities_3lib_16element_mappings_ElementSampler->tp_dict); if (unlikely(!__pyx_vtabptr_2yt_9utilities_3lib_16element_mappings_ElementSampler)) {__pyx_filename = __pyx_f[5]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_2yt_9utilities_3lib_16element_mappings_Q1Sampler2D = __Pyx_ImportType("yt.utilities.lib.element_mappings", "Q1Sampler2D", sizeof(struct __pyx_obj_2yt_9utilities_3lib_16element_mappings_Q1Sampler2D), 1); if (unlikely(!__pyx_ptype_2yt_9utilities_3lib_16element_mappings_Q1Sampler2D)) {__pyx_filename = __pyx_f[5]; __pyx_lineno = 210; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_2yt_9utilities_3lib_16element_mappings_Q1Sampler2D = (struct __pyx_vtabstruct_2yt_9utilities_3lib_16element_mappings_Q1Sampler2D*)__Pyx_GetVtable(__pyx_ptype_2yt_9utilities_3lib_16element_mappings_Q1Sampler2D->tp_dict); if (unlikely(!__pyx_vtabptr_2yt_9utilities_3lib_16element_mappings_Q1Sampler2D)) {__pyx_filename = __pyx_f[5]; __pyx_lineno = 210; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_2yt_9utilities_3lib_25bounding_volume_hierarchy_BVH = __Pyx_ImportType("yt.utilities.lib.bounding_volume_hierarchy", "BVH", sizeof(struct __pyx_obj_2yt_9utilities_3lib_25bounding_volume_hierarchy_BVH), 1); if (unlikely(!__pyx_ptype_2yt_9utilities_3lib_25bounding_volume_hierarchy_BVH)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "sample_hex20", (void (**)(void))&__pyx_f_2yt_9utilities_3lib_13mesh_samplers_sample_hex20, "void (void *, struct RTCRay &)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  Py_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_2 = __Pyx_ImportModule("yt.utilities.lib.primitives"); if (!__pyx_t_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_2, "__pyx_fuse_0compute_patch_hit", (void (**)(void))&__pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_compute_patch_hit, "struct __pyx_t_2yt_9utilities_3lib_10primitives_RayHitData (float (*)[3], float *, float *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_2, "__pyx_fuse_1compute_patch_hit", (void (**)(void))&__pyx_fuse_1__pyx_f_2yt_9utilities_3lib_10primitives_compute_patch_hit, "struct __pyx_t_2yt_9utilities_3lib_10primitives_RayHitData (double (*)[3], double *, double *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_2, "__pyx_fuse_0patchSurfaceFunc", (void (**)(void))&__pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceFunc, "void (float (*)[3], float const , float const , float *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_2, "__pyx_fuse_1patchSurfaceFunc", (void (**)(void))&__pyx_fuse_1__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceFunc, "void (double (*)[3], double const , double const , double *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_2, "__pyx_fuse_0patchSurfaceDerivU", (void (**)(void))&__pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivU, "void (float (*)[3], float const , float const , float *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_2, "__pyx_fuse_1patchSurfaceDerivU", (void (**)(void))&__pyx_fuse_1__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivU, "void (double (*)[3], double const , double const , double *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_2, "__pyx_fuse_0patchSurfaceDerivV", (void (**)(void))&__pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivV, "void (float (*)[3], float const , float const , float *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ImportFunction(__pyx_t_2, "__pyx_fuse_1patchSurfaceDerivV", (void (**)(void))&__pyx_fuse_1__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivV, "void (double (*)[3], double const , double const , double *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "yt/utilities/lib/mesh_intersection.pyx":1
 * """             # <<<<<<<<<<<<<<
 * This file contains functions used for performing ray-tracing with 2nd-order Lagrange
 * Elements.
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init yt.utilities.lib.mesh_intersection", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init yt.utilities.lib.mesh_intersection");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
