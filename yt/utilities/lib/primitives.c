...
/* "yt/utilities/lib/primitives.pyx":19
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":27
 *     cdef np.int64_t i
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "yt/utilities/lib/primitives.pyx":28
 *     cdef np.float64_t t1, t2
 *     for i in range(3):
 *         t1 = (bbox.left_edge[i]  - ray.origin[i])*ray.inv_dir[i]             # <<<<<<<<<<<<<<
 *         t2 = (bbox.right_edge[i] - ray.origin[i])*ray.inv_dir[i]
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":29
 *     for i in range(3):
 *         t1 = (bbox.left_edge[i]  - ray.origin[i])*ray.inv_dir[i]
 *         t2 = (bbox.right_edge[i] - ray.origin[i])*ray.inv_dir[i]             # <<<<<<<<<<<<<<
 *         tmin = fmax(tmin, fmin(t1, t2))
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":30
 *         t1 = (bbox.left_edge[i]  - ray.origin[i])*ray.inv_dir[i]
 *         t2 = (bbox.right_edge[i] - ray.origin[i])*ray.inv_dir[i]
 *         tmin = fmax(tmin, fmin(t1, t2))             # <<<<<<<<<<<<<<
 *         tmax = fmin(tmax, fmax(t1, t2))
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":31
 *         t2 = (bbox.right_edge[i] - ray.origin[i])*ray.inv_dir[i]
 *         tmin = fmax(tmin, fmin(t1, t2))
 *         tmax = fmin(tmax, fmax(t1, t2))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":33
 *         tmax = fmin(tmax, fmax(t1, t2))
 * 
 *     return tmax >= fmax(tmin, 0.0)             # <<<<<<<<<<<<<<
 * 
...
/* "yt/utilities/lib/primitives.pyx":38
 * @cython.wraparound(False)
 * @cython.cdivision(True)
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":55
 * 
 *     cdef np.float64_t det, inv_det
 *     det = dot(e1, P)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "yt/utilities/lib/primitives.pyx":57
 *     det = dot(e1, P)
 *     if(det > -DETERMINANT_EPS and det < DETERMINANT_EPS):
 *         return False             # <<<<<<<<<<<<<<
 *     inv_det = 1.0 / det
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":63
 *     subtract(ray.origin, tri.p0, T)
 * 
 *     cdef np.float64_t u = dot(T, P) * inv_det             # <<<<<<<<<<<<<<
 *     if(u < 0.0 or u > 1.0):
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":64
 * 
 *     cdef np.float64_t u = dot(T, P) * inv_det
 *     if(u < 0.0 or u > 1.0):             # <<<<<<<<<<<<<<
 *         return False
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "yt/utilities/lib/primitives.pyx":65
 *     cdef np.float64_t u = dot(T, P) * inv_det
 *     if(u < 0.0 or u > 1.0):
 *         return False             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":68
 * 
 *     cdef np.float64_t Q[3]
 *     cross(T, e1, Q)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":70
 *     cross(T, e1, Q)
 * 
 *     cdef np.float64_t v = dot(ray.direction, Q) * inv_det             # <<<<<<<<<<<<<<
 *     if(v < 0.0 or u + v  > 1.0):
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":71
 * 
 *     cdef np.float64_t v = dot(ray.direction, Q) * inv_det
 *     if(v < 0.0 or u + v  > 1.0):             # <<<<<<<<<<<<<<
 *         return False
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "yt/utilities/lib/primitives.pyx":72
 *     cdef np.float64_t v = dot(ray.direction, Q) * inv_det
 *     if(v < 0.0 or u + v  > 1.0):
 *         return False             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":74
 *         return False
 * 
 *     cdef np.float64_t t = dot(e2, Q) * inv_det             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "yt/utilities/lib/primitives.pyx":77
 * 
 *     if(t > DETERMINANT_EPS and t < ray.t_far):
 *         ray.t_far = t             # <<<<<<<<<<<<<<
 *         ray.elem_id = tri.elem_id
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "yt/utilities/lib/primitives.pyx":121
 *   cdef int i
 *   for i in range(3):
 *       S[i] = 0.25*(1.0 - u)*(1.0 - v)*(-u - v - 1)*verts[0][i] + \             # <<<<<<<<<<<<<<
 *              0.25*(1.0 + u)*(1.0 - v)*( u - v - 1)*verts[1][i] + \
...
static void __pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivU(float (*__pyx_v_verts)[3], float const __pyx_v_u, float const __pyx_v_v, float *__pyx_v_Su) {
  ...
  /* "yt/utilities/lib/primitives.pyx":139
...
static void __pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivV(float (*__pyx_v_verts)[3], float const __pyx_v_u, float const __pyx_v_v, float *__pyx_v_Sv) {
  ...
  /* "yt/utilities/lib/primitives.pyx":156
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "yt/utilities/lib/primitives.pyx":157
 *     cdef int i
 *     for i in range(3):
 *         Sv[i] = (-0.25*(u - 1.0)*(u + v + 1) - 0.25*(u - 1.0)*(v - 1.0))*verts[0][i] + \             # <<<<<<<<<<<<<<
 *                 (-0.25*(u + 1.0)*(u - v - 1) + 0.25*(u + 1.0)*(v - 1.0))*verts[1][i] + \
...
/* "yt/utilities/lib/primitives.pyx":168
 * @cython.wraparound(False)
 * @cython.cdivision(True)
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":175
 *     cdef cython.floating[3] n, N1, N2
 *     cdef cython.floating A = dot(ray_direction, ray_direction)
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         n[i] = ray_direction[i] / A
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":178
 *         n[i] = ray_direction[i] / A
 * 
 *     if ((fabs(n[0]) > fabs(n[1])) and (fabs(n[0]) > fabs(n[2]))):             # <<<<<<<<<<<<<<
 *         N1[0] = n[1]
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "yt/utilities/lib/primitives.pyx":179
 * 
 *     if ((fabs(n[0]) > fabs(n[1])) and (fabs(n[0]) > fabs(n[2]))):
 *         N1[0] = n[1]             # <<<<<<<<<<<<<<
 *         N1[1] =-n[0]
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":180
 *     if ((fabs(n[0]) > fabs(n[1])) and (fabs(n[0]) > fabs(n[2]))):
 *         N1[0] = n[1]
 *         N1[1] =-n[0]             # <<<<<<<<<<<<<<
 *         N1[2] = 0.0
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":181
 *         N1[0] = n[1]
 *         N1[1] =-n[0]
 *         N1[2] = 0.0             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":183
 *         N1[2] = 0.0
 *     else:
 *         N1[0] = 0.0             # <<<<<<<<<<<<<<
 *         N1[1] = n[2]
 ...
 */
  /*else*/ {
    ...
    /* "yt/utilities/lib/primitives.pyx":184
 *     else:
 *         N1[0] = 0.0
 *         N1[1] = n[2]             # <<<<<<<<<<<<<<
 *         N1[2] =-n[1]
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":185
 *         N1[0] = 0.0
 *         N1[1] = n[2]
 *         N1[2] =-n[1]             # <<<<<<<<<<<<<<
 *     cross(N1, n, N2)
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":186
 *         N1[1] = n[2]
 *         N1[2] =-n[1]
 *     cross(N1, n, N2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":188
 *     cross(N1, n, N2)
 * 
 *     cdef cython.floating d1 = -dot(N1, ray_origin)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":189
 * 
 *     cdef cython.floating d1 = -dot(N1, ray_origin)
 *     cdef cython.floating d2 = -dot(N2, ray_origin)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":192
 * 
 *     # the initial guess is set to zero
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":193
 *     # the initial guess is set to zero
 *     cdef cython.floating u = 0.0
 *     cdef cython.floating v = 0.0             # <<<<<<<<<<<<<<
 *     cdef cython.floating[3] S
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":195
 *     cdef cython.floating v = 0.0
 *     cdef cython.floating[3] S
 *     patchSurfaceFunc(verts, u, v, S)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":196
 *     cdef cython.floating[3] S
 *     patchSurfaceFunc(verts, u, v, S)
 *     cdef cython.floating fu = dot(N1, S) + d1             # <<<<<<<<<<<<<<
 *     cdef cython.floating fv = dot(N2, S) + d2
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":202
 *     # begin Newton interation
 *     cdef cython.floating tol = 1.0e-5
 *     cdef int iterations = 0             # <<<<<<<<<<<<<<
 *     cdef int max_iter = 10
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":203
 *     cdef cython.floating tol = 1.0e-5
 *     cdef int iterations = 0
 *     cdef int max_iter = 10             # <<<<<<<<<<<<<<
 *     cdef cython.floating[3] Su
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":207
 *     cdef cython.floating[3] Sv
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":210
 *         # compute the Jacobian
 *         patchSurfaceDerivU(verts, u, v, Su)
 *         patchSurfaceDerivV(verts, u, v, Sv)             # <<<<<<<<<<<<<<
 *         J11 = dot(N1, Su)
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":211
 *         patchSurfaceDerivU(verts, u, v, Su)
 *         patchSurfaceDerivV(verts, u, v, Sv)
 *         J11 = dot(N1, Su)             # <<<<<<<<<<<<<<
 *         J12 = dot(N1, Sv)
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":213
 *         J11 = dot(N1, Su)
 *         J12 = dot(N1, Sv)
 *         J21 = dot(N2, Su)             # <<<<<<<<<<<<<<
 *         J22 = dot(N2, Sv)
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":214
 *         J12 = dot(N1, Sv)
 *         J21 = dot(N2, Su)
 *         J22 = dot(N2, Sv)             # <<<<<<<<<<<<<<
 *         det = (J11*J22 - J12*J21)
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":215
 *         J21 = dot(N2, Su)
 *         J22 = dot(N2, Sv)
 *         det = (J11*J22 - J12*J21)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":218
 * 
 *         # update the u, v values
 *         u -= ( J22*fu - J12*fv) / det             # <<<<<<<<<<<<<<
 *         v -= (-J21*fu + J11*fv) / det
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":219
 *         # update the u, v values
 *         u -= ( J22*fu - J12*fv) / det
 *         v -= (-J21*fu + J11*fv) / det             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":222
 * 
 *         patchSurfaceFunc(verts, u, v, S)
 *         fu = dot(N1, S) + d1             # <<<<<<<<<<<<<<
 *         fv = dot(N2, S) + d2
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":225
 *         fv = dot(N2, S) + d2
 * 
 *         err = fmax(fabs(fu), fabs(fv))             # <<<<<<<<<<<<<<
 *         iterations += 1
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":226
 * 
 *         err = fmax(fabs(fu), fabs(fv))
 *         iterations += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":229
 * 
 *     # t is the distance along the ray to this hit
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":233
 *     # return hit data
 *     cdef RayHitData hd
 *     hd.u = u             # <<<<<<<<<<<<<<
 *     hd.v = v
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":234
 *     cdef RayHitData hd
 *     hd.u = u
 *     hd.v = v             # <<<<<<<<<<<<<<
 *     hd.t = t
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":236
 *     hd.v = v
 *     hd.t = t
 *     hd.converged = (iterations < max_iter)             # <<<<<<<<<<<<<<
 *     return hd
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":237
 *     hd.t = t
 *     hd.converged = (iterations < max_iter)
 *     return hd             # <<<<<<<<<<<<<<
 * 
...
/* "yt/utilities/lib/primitives.pyx":243
 * @cython.wraparound(False)
 * @cython.cdivision(True)
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 8; __pyx_t_1+=1) {
    ...
    /* "yt/utilities/lib/primitives.pyx":278
 * 
 *     for i in range(8):
 *         for j in range(3):             # <<<<<<<<<<<<<<
 *             centroid[j] += patch.v[i][j]
 ...
 */
    ...
    /* "yt/utilities/lib/primitives.pyx":297
 *     for j in range(3):
 *         bbox.left_edge[j] = patch.v[0][j]
 *         bbox.right_edge[j] = patch.v[0][j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  for (__pyx_t_1 = 1; __pyx_t_1 < 8; __pyx_t_1+=1) {
    ...
    /* "yt/utilities/lib/primitives.pyx":300
 * 
 *     for i in range(1, 8):
 *         for j in range(3):             # <<<<<<<<<<<<<<
 *             bbox.left_edge[j] = fmin(bbox.left_edge[j], patch.v[i][j])
 ...
 */
    for (__pyx_t_2 = 0; __pyx_t_2 < 3; __pyx_t_2+=1) {
      ...
      /* "yt/utilities/lib/primitives.pyx":301
 *     for i in range(1, 8):
 *         for j in range(3):
 *             bbox.left_edge[j] = fmin(bbox.left_edge[j], patch.v[i][j])             # <<<<<<<<<<<<<<
 *             bbox.right_edge[j] = fmax(bbox.right_edge[j], patch.v[i][j])
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "yt.utilities.lib.primitives")) {
      if (unlikely(PyDict_SetItemString(modules, "yt.utilities.lib.primitives", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("ray_bbox_intersect", (void (*)(void))__pyx_f_2yt_9utilities_3lib_10primitives_ray_bbox_intersect, "__pyx_t_5numpy_int64_t (struct __pyx_t_2yt_9utilities_3lib_10primitives_Ray *, struct __pyx_t_2yt_9utilities_3lib_10primitives_BBox const )") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("ray_triangle_intersect", (void (*)(void))__pyx_f_2yt_9utilities_3lib_10primitives_ray_triangle_intersect, "__pyx_t_5numpy_int64_t (void const *, __pyx_t_5numpy_int64_t const , struct __pyx_t_2yt_9utilities_3lib_10primitives_Ray *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("triangle_centroid", (void (*)(void))__pyx_f_2yt_9utilities_3lib_10primitives_triangle_centroid, "void (void const *, __pyx_t_5numpy_int64_t const , __pyx_t_5numpy_float64_t *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("triangle_bbox", (void (*)(void))__pyx_f_2yt_9utilities_3lib_10primitives_triangle_bbox, "void (void const *, __pyx_t_5numpy_int64_t const , struct __pyx_t_2yt_9utilities_3lib_10primitives_BBox *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("ray_patch_intersect", (void (*)(void))__pyx_f_2yt_9utilities_3lib_10primitives_ray_patch_intersect, "__pyx_t_5numpy_int64_t (void const *, __pyx_t_5numpy_int64_t const , struct __pyx_t_2yt_9utilities_3lib_10primitives_Ray *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("patch_centroid", (void (*)(void))__pyx_f_2yt_9utilities_3lib_10primitives_patch_centroid, "void (void const *, __pyx_t_5numpy_int64_t const , __pyx_t_5numpy_float64_t *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("patch_bbox", (void (*)(void))__pyx_f_2yt_9utilities_3lib_10primitives_patch_bbox, "void (void const *, __pyx_t_5numpy_int64_t const , struct __pyx_t_2yt_9utilities_3lib_10primitives_BBox *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_0patchSurfaceFunc", (void (*)(void))__pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceFunc, "void (float (*)[3], float const , float const , float *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_1patchSurfaceFunc", (void (*)(void))__pyx_fuse_1__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceFunc, "void (double (*)[3], double const , double const , double *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_0patchSurfaceDerivU", (void (*)(void))__pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivU, "void (float (*)[3], float const , float const , float *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_1patchSurfaceDerivU", (void (*)(void))__pyx_fuse_1__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivU, "void (double (*)[3], double const , double const , double *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_0patchSurfaceDerivV", (void (*)(void))__pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivV, "void (float (*)[3], float const , float const , float *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_1patchSurfaceDerivV", (void (*)(void))__pyx_fuse_1__pyx_f_2yt_9utilities_3lib_10primitives_patchSurfaceDerivV, "void (double (*)[3], double const , double const , double *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("__pyx_fuse_0compute_patch_hit", (void (*)(void))__pyx_fuse_0__pyx_f_2yt_9utilities_3lib_10primitives_compute_patch_hit, "struct __pyx_t_2yt_9utilities_3lib_10primitives_RayHitData (float (*)[3], float *, float *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "yt/utilities/lib/primitives.pyx":2
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":9
 ...
 */
  ...
  /* "yt/utilities/lib/primitives.pyx":10
 * 
 * cdef np.float64_t DETERMINANT_EPS = 1.0e-10
 * cdef np.float64_t INF = np.inf             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_3 == (npy_float64)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
