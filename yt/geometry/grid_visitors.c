...
static char __pyx_k_Grid_visitor_functions[] = "\nGrid visitor functions\n\n\n\n\n";
 ...
 *                 break
 */
      __pyx_t_5 = (((__pyx_v_data->pos[__pyx_v_j]) < (__pyx_v_tup[((__pyx_v_j * 2) + 0)])) != 0);
      if (!__pyx_t_5) {
      } else {
        __pyx_t_4 = __pyx_t_5;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_5 = (((__pyx_v_data->pos[__pyx_v_j]) > (__pyx_v_tup[((__pyx_v_j * 2) + 1)])) != 0);
      __pyx_t_4 = __pyx_t_5;
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initgrid_visitors(void); /*proto*/
PyMODINIT_FUNC initgrid_visitors(void)
#else
PyMODINIT_FUNC PyInit_grid_visitors(void); /*proto*/
PyMODINIT_FUNC PyInit_grid_visitors(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_grid_visitors(void)", 0);
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "yt.geometry.grid_visitors")) {
      if (unlikely(PyDict_SetItemString(modules, "yt.geometry.grid_visitors", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("free_tuples", (void (*)(void))__pyx_f_2yt_8geometry_13grid_visitors_free_tuples, "void (struct __pyx_t_2yt_8geometry_13grid_visitors_GridVisitorData *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("setup_tuples", (void (*)(void))__pyx_f_2yt_8geometry_13grid_visitors_setup_tuples, "void (struct __pyx_t_2yt_8geometry_13grid_visitors_GridVisitorData *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("check_child_masked", (void (*)(void))__pyx_f_2yt_8geometry_13grid_visitors_check_child_masked, "__pyx_t_5numpy_uint8_t (struct __pyx_t_2yt_8geometry_13grid_visitors_GridVisitorData *)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("count_cells", (void (*)(void))__pyx_f_2yt_8geometry_13grid_visitors_count_cells, "void (struct __pyx_t_2yt_8geometry_13grid_visitors_GridVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("mask_cells", (void (*)(void))__pyx_f_2yt_8geometry_13grid_visitors_mask_cells, "void (struct __pyx_t_2yt_8geometry_13grid_visitors_GridVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("icoords_cells", (void (*)(void))__pyx_f_2yt_8geometry_13grid_visitors_icoords_cells, "void (struct __pyx_t_2yt_8geometry_13grid_visitors_GridVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("ires_cells", (void (*)(void))__pyx_f_2yt_8geometry_13grid_visitors_ires_cells, "void (struct __pyx_t_2yt_8geometry_13grid_visitors_GridVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("fcoords_cells", (void (*)(void))__pyx_f_2yt_8geometry_13grid_visitors_fcoords_cells, "void (struct __pyx_t_2yt_8geometry_13grid_visitors_GridVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("fwidth_cells", (void (*)(void))__pyx_f_2yt_8geometry_13grid_visitors_fwidth_cells, "void (struct __pyx_t_2yt_8geometry_13grid_visitors_GridVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
  ...
  __pyx_ptype_2yt_9utilities_3lib_8bitarray_bitarray = __Pyx_ImportType("yt.utilities.lib.bitarray", "bitarray", sizeof(struct __pyx_obj_2yt_9utilities_3lib_8bitarray_bitarray), 1); if (unlikely(!__pyx_ptype_2yt_9utilities_3lib_8bitarray_bitarray)) {__pyx_filename = __pyx_f[3]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_2yt_9utilities_3lib_8bitarray_bitarray = (struct __pyx_vtabstruct_2yt_9utilities_3lib_8bitarray_bitarray*)__Pyx_GetVtable(__pyx_ptype_2yt_9utilities_3lib_8bitarray_bitarray->tp_dict); if (unlikely(!__pyx_vtabptr_2yt_9utilities_3lib_8bitarray_bitarray)) {__pyx_filename = __pyx_f[3]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
